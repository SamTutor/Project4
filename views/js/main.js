...
var resizePizzas = function(size) { 
  ...
  // Changes made is dx and newwidth is placed outside the for loop. 
  // Created randpizzaCont to equal the value of the randomPizzaContainer[0]
  function changePizzaSizes(size) {
    var randPizzaCont = document.getElementsByClassName("randomPizzaContainer")[0];
    var dx = determineDx(randPizzaCont, size);
    var newwidth = (randPizzaCont.offsetWidth + dx) + 'px';
...
// Changes made is pizzasDiv is placed outside the for loop. 
...
// Using the following website http://www.html5rocks.com/en/tutorials/speed/animations/
// created onScrollTick to keep track of the last scroll and only update the last scroll data  
var lastScroll = 0, tick = false;
...
// Changes made resized the pizza.png to 70px x 70px also change the number of pizza created from 200 to 25
